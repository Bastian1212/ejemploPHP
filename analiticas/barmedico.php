...
<body>
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    ...
                                    <li class="nav-item">
                                            <a class="nav-link" href="barrecetas.php">Recetas</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="barmedico.php">Medico</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="barpacientes.php">Paciente</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <div id="overview" class="page-section">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <h2>MEDICOS</h2>
                            <p class="lead">Cantidad de atenciones de cada medico</p>
                            <h3 class="text-center">ATENCIONES DE CADA MEDICO</h3>
                        </div>
                        <div>
                            <svg id="medico" width="875" height="350"></svg>
                        </div>
                    </div>
                </div>
            </div>  <!-- ============================================================== -->
   ...
   <!-- slimscroll js -->
    ...
    <script type="text/javascript" src="./assets/libs/js/barnumatencion.js"></script>
</body>
</html>