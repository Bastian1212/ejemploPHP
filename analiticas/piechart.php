...
<body>
                ...
                <div id="overview" class="page-section">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <h2>Pie Chart</h2>
                            <p class="lead">Cantidad de atenciones que recetaron cada medicamento xd</p>
                            <h3 class="text-center">Medicamentos</h3>
                        </div>
                        <div>
                            <div id="tortita" class="piechart" width="875" height="350"></div>
                        </div>
                    </div>
                </div>
            </div>  <!-- ============================================================== -->
   ...
   <!-- slimscroll js -->
    ...
    <script type="text/javascript" src="./assets/libs/js/piechart1.js"></script>
</body>
</html>